...
public class Game extends Activity implements OnClickListener {
	...
	int duration = 30;			// any value up to 30 seconds
...
//        myPhotos.addView(createImageView(R.drawable.diglet));
//        myPhotos.addView(createImageView(R.drawable.grass));
//        myPhotos.addView(createImageView(R.drawable.ic_launcher));
