...
public class AddAlarm extends Activity implements OnClickListener
{
    ...
    //
    class MyDatePicker extends DialogFragment 
                                     implements DatePickerDialog.OnDateSetListener
    {
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) 
        {
        	...
        	// set the text of the date button to reflect the user's date
    ...
    // This class is completed by the student in the Chapter 10 Activity
    //
    class MyTimePicker extends DialogFragment 
    ...
    // This class is completed by the student in the Chapter 10 Activity
    //
    class MyAlertDialog extends DialogFragment 
    {
        	...
        	builder.setPositiveButton("Yes",
        			new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int id) {
							...
							// when the yes button is clicked set the alarm and then clear the screen
